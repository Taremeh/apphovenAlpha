...
@Component({
  ...
  templateUrl: 'shared/side-drawer/side-drawer-page/side-drawer-page.component.html',
  styleUrls: ['shared/side-drawer/side-drawer-page/side-drawer-page.component.css']
})
